...
class IOMarket {
 public:
	...
	static void createOffer(uint32_t playerId, MarketAction_t action, uint32_t itemId,
	...
	static void appendHistory(uint32_t playerId, MarketAction_t type, uint16_t itemId,
