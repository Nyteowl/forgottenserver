...
class Monster final : public Creature {
 public:
	...
	const std::string& getName() const override { return mType->name; }
	const std::string& getNameDescription() const override { return mType->nameDescription; }
	std::string getDescription(int32_t) const override { return strDescription + '.'; }
	...
	bool canPushItems() const { return mType->info.canPushItems; }
	...
	bool hasExtraSwing() override { return extraMeleeAttack; }
