...
using RuneSpellFunction =
		std::function<bool(const RuneSpell* spell, Player* player, const Position& posTo)>;
...
class RuneSpell final : public Action, public Spell {
 public:
	...
	bool executeUse(Player* player, Item* item, const Position& fromPosition, Thing* target,
