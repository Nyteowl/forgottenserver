...
class Condition {
 public:
	Condition() = default;
	Condition(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
	...
	static Condition* createCondition(ConditionId_t id, ConditionType_t type, int32_t ticks,
...
class ConditionGeneric : public Condition {
 public:
	ConditionGeneric(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
									 uint32_t subId = 0, bool aggressive = false)
...
class ConditionAttributes final : public ConditionGeneric {
 public:
	ConditionAttributes(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
											uint32_t subId = 0, bool aggressive = false)
...
class ConditionRegeneration final : public ConditionGeneric {
 public:
	ConditionRegeneration(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
												uint32_t subId = 0, bool aggressive = false)
			: ConditionGeneric(id, type, ticks, buff, subId, aggressive) {}
...
class ConditionSoul final : public ConditionGeneric {
 public:
	ConditionSoul(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
								uint32_t subId = 0, bool aggressive = false)
			: ConditionGeneric(id, type, ticks, buff, subId, aggressive) {}
...
class ConditionInvisible final : public ConditionGeneric {
 public:
	ConditionInvisible(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
										 uint32_t subId = 0, bool aggressive = false)
			: ConditionGeneric(id, type, ticks, buff, subId, aggressive) {}
...
class ConditionOutfit final : public Condition {
 public:
	ConditionOutfit(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
									uint32_t subId = 0, bool aggressive = false)
			: Condition(id, type, ticks, buff, subId, aggressive) {}
...
class ConditionLight final : public Condition {
 public:
	ConditionLight(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff, uint32_t subId,
...
class ConditionSpellCooldown final : public ConditionGeneric {
 public:
	ConditionSpellCooldown(ConditionId_t id, ConditionType_t type, int32_t ticks, bool buff = false,
												 uint32_t subId = 0, bool aggressive = false)
			: ConditionGeneric(id, type, ticks, buff, subId, aggressive) {}
...
class ConditionSpellGroupCooldown final : public ConditionGeneric {
 public:
	ConditionSpellGroupCooldown(ConditionId_t id, ConditionType_t type, int32_t ticks,
