...
class ProtocolGame final : public Protocol {
 ...
 private:
	...
	void sendVIP(uint32_t guid, const std::string& name, const std::string& description,
	...
	void GetFloorDescription(NetworkMessage& msg, int32_t x, int32_t y, int32_t z, int32_t width,
	...
	void addGameTaskTimed(uint32_t delay, Callable function, Args&&... args) {
		g_dispatcher.addTask(
				createTask(delay, std::bind(function, &g_game, std::forward<Args>(args)...)));
	}
